export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx9875dd28c2b81ed8",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "8c6e0e3f6356384022e4c1a462d32a8f",
  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "2002", "date": "12-31"},
        {"type": "节日", "name": "纪念日", "year": "2019", "date": "12-16"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "我", "year": "2003", "date": "09-16"},
      ]
  ...
  CALLBACK_TEMPLATE_ID: "aJ1k0pIyENlmh4V72Wa7RWo0NgLuMFZcXRFghIC49KY	",
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "oC7ys6Sq7_ypa45UKWY6mMBy2Ivk",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
